    ...
    const handleLogoClick = () => {
      ...
      const handleSubmit = async (event) => {
        ...
        try {
          ...
          await api.post("/associado/cadastro", { NM_PESSOA, NR_CELULAR, NR_TELEFONE, NATURALIDADE, SEXO, DT_NASCIMENTO, ESTADO_CIVIL, EMAIL, CD_EQUIPA_LOCOMOCAO, CD_DEFICIENCIA: selectedDeficiencias, MEIO_LOCOMOCAO: selectedMeios, CD_FUNCAO: selectedFuncaos, ASSISTENCIA, NM_PAI, CELULAR_PAI, NM_MAE, CELULAR_MAE, EMAIL_RESPONS, NATURALIDADE_RESPONS, PESO, ALTURA, GP_SANGUE, RENDA, ESCOLARIDADE, INSTITUICAO, TELEFONE_ESCOLA, CPF, RG, UF_RG, DT_EMISSAO_RG, NR_PASSAPORTE, CPF_RESPONS, RG_RESPONS, UF_RG_RESPONS, DT_EMISSAO_RG_RESPONS, NR_PASSAPORTE_RESPONS, ENDERECO, NR_ENDERECO, DS_ENDERECO, CEP, CD_MODALIDADE: selectedModalidades, CLASSIF_FUNC, PROVA, TAMANHO_CAMISA, TAMANHO_AGASALHO, TAMANHO_BERM_CAL, NR_CALCADO, FOTO_ATLETA, FOTO_RG, FOTO_RG_RESPONS }, config);
        ...
        <Container>
            <header>
                <nav>
                    <Row>
                        <Col md={3}>
                            <img className='logo' src="../../../assets/img/cepe_joinville_laranja 2.png" alt="logo" onClick={handleLogoClick} />
                        </Col>
            ...
            <main>
                <Form onSubmit={handleSubmit}>
                    ...
                    <FormGroup>
                        ...
                        <Input type="text" id="NM_PESSOA" name="NM_PESSOA" value={NM_PESSOA} onChange={(e) => setNmPessoa(e.target.value)} />
                    </FormGroup>
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="NR_CELULAR">Telefone Celular:</Label>
                                <Input type="tel" id="NR_CELULAR" name="NR_CELULAR" placeholder="(00) 00000-0000" maxlength="15" pattern="\(\d{2}\) \d{5}-\d{4}" value={NR_CELULAR} onChange={(e) => setNrCelular(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="NR_TELEFONE">Telefone Residencial:</Label>
                                <Input type="tel" id="NR_TELEFONE" name="NR_TELEFONE" placeholder="(00) 00000-0000" maxlength="15" pattern="\(\d{2}\) \d{5}-\d{4}" value={NR_TELEFONE} onChange={(e) => setNrTelefone(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="NATURALIDADE">Naturalidade:</Label>
                                <Input type="text" id="NATURALIDADE" name="NATURALIDADE" value={NATURALIDADE} onChange={(e) => setNaturalidade(e.target.value)} />
                            </FormGroup>
                        </Col>
                        </Row>
                        <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="select" name="SEXO" id="SEXO" value={SEXO} onChange={(e) => setSexo(e.target.value)} >
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="date" id="DT_NASCIMENTO" name="DT_NASCIMENTO" value={DT_NASCIMENTO} onChange={(e) => setDtNascimento(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="ESTADO_CIVIL">Estado Civil:</Label>
                                <Input type="select" name="ESTADO_CIVIL" id="ESTADO_CIVIL" value={ESTADO_CIVIL} onChange={(e) => setEstadoCivil(e.target.value)}>
                                    <option value=" ">Selecione</option>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="CD_EQUIPA_LOCOMOCAO" name="CD_EQUIPA_LOCOMOCAO" value={CD_EQUIPA_LOCOMOCAO} onChange={(e) => setEquipaLocomocao(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="CD_DEFICIENCIA">Deficiência:</Label>
                                    <select
                                        ...
                                        {deficiencia.map((deficiencia) => (
                                            <option key={deficiencia.CD_DEFICIENCIA} value={deficiencia.CD_DEFICIENCIA}>
                            ...
                            <FormGroup>
                                <Label for="MEIO_LOCOMOCAO">Meio de locomoção:</Label>
                                    <select
                                        ...
                                        {meio.map((meio) => (
                                            <option key={meio.CD_MEIO_LOCOMOCAO} value={meio.CD_MEIO_LOCOMOCAO}>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="ASSISTENCIA" name="ASSISTENCIA" value={ASSISTENCIA} onChange={(e) => setAssistencia(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    ...
                    <Row form>
                        <Col md={5}>
                            <FormGroup>
                                ...
                                <Input type="text" id="NM_PAI" name="NM_PAI" value={NM_PAI} onChange={(e) => setNmPai(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={5}>
                            <FormGroup>
                                <Label for="CELULAR_PAI">Telefone Celular Pai:</Label>
                                <Input type="tel" id="CELULAR_PAI" name="CELULAR_PAI" placeholder="(00) 00000-0000" maxlength="15" pattern="\(\d{2}\) \d{5}-\d{4}" value={CELULAR_PAI} onChange={(e) => setCelularPai(e.target.value)} />
                            </FormGroup>
                        </Col>
                        .
                        <Col md={5}>
                            <FormGroup>
                                ...
                                <Input type="text" id="NM_MAE" name="NM_MAE" value={NM_MAE} onChange={(e) => setNmMae(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={5}>
                            <FormGroup>
                                <Label for="CELULAR_MAE">Telefone Celular Mãe:</Label>
                                <Input type="tel" id="CELULAR_MAE" name="CELULAR_MAE" placeholder="(00) 00000-0000" maxlength="15" pattern="\(\d{2}\) \d{5}-\d{4}" value={CELULAR_MAE} onChange={(e) => setCelularMae(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                        <Col md={5}>
                            <FormGroup>
                                ...
                                <Input type="email" id="EMAIL_RESPONS" name="EMAIL_RESPONS" value={EMAIL_RESPONS} onChange={(e) => setEmailRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={5}>
                            <FormGroup>
                                <Label for="NATURALIDADE_RESPONS">Naturalidade do Responsável:</Label>
                                <Input type="text" id="NATURALIDADE_RESPONS" name="NATURALIDADE_RESPONS" value={NATURALIDADE_RESPONS} onChange={(e) => setNaturalidadeRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    ...
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="number" id="PESO" name="PESO" step="0.1" value={PESO} onChange={(e) => setPeso(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="GP_SANGUE" name="GP_SANGUE" value={GP_SANGUE} onChange={(e) => setGpSangue(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="RENDA" name="RENDA" value={RENDA} onChange={(e) => setRenda(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="ESCOLARIDADE">Escolaridade:</Label>
                                <Input type="text" id="ESCOLARIDADE" name="ESCOLARIDADE" value={ESCOLARIDADE} onChange={(e) => setEscolaridade(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="INSTITUICAO">Instituição de Ensino:</Label>
                                <Input type="text" id="INSTITUICAO" name="INSTITUICAO" value={INSTITUICAO} onChange={(e) => setInstituicao(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="TELEFONE_ESCOLA" name="TELEFONE_ESCOLA" value={TELEFONE_ESCOLA} onChange={(e) => setTelefoneEscola(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <h2>Documentos</h2>
                    <Row form>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="RG" name="RG" value={RG} onChange={(e) => setRg(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="UF_RG">UF do RG:</Label>
                                <Input type="text" id="UF_RG" name="UF_RG" value={UF_RG} onChange={(e) => setUfRg(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="DT_EMISSAO_RG">Data de Emissão do RG:</Label>
                                <Input type="date" id="DT_EMISSAO_RG" name="DT_EMISSAO_RG" value={DT_EMISSAO_RG} onChange={(e) => setDtEmissaoRg(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="NR_PASSAPORTE">Número do Passaporte:</Label>
                                <Input type="text" id="NR_PASSAPORTE" name="NR_PASSAPORTE" value={NR_PASSAPORTE} onChange={(e) => setNrPassaporte(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    ...
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="CPF_RESPONS" name="CPF_RESPONS" value={CPF_RESPONS} onChange={(e) => setCpfRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="RG_RESPONS">RG do Responsável:</Label>
                                <Input type="text" id="RG_RESPONS" name="RG_RESPONS" value={RG_RESPONS} onChange={(e) => setRgRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="UF_RG_RESPONS">UF do RG do Responsável:</Label>
                                <Input type="text" id="UF_RG_RESPONS" name="UF_RG_RESPONS" value={UF_RG_RESPONS} onChange={(e) => setUfRgRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="DT_EMISSAO_RG_RESPONS">Data de Emissão do RG do Responsável:</Label>
                                <Input type="date" id="DT_EMISSAO_RG_RESPONS" name="DT_EMISSAO_RG_RESPONS" value={DT_EMISSAO_RG_RESPONS} onChange={(e) => setDtEmissaoRgRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="NR_PASSAPORTE_RESPONS">Número do Passaporte do Responsável:</Label>
                                <Input type="text" id="NR_PASSAPORTE_RESPONS" name="NR_PASSAPORTE_RESPONS" value={NR_PASSAPORTE_RESPONS} onChange={(e) => setNrPassaporteRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <h2>Endereço</h2>
                    <Row form>
                        ...
                        <Col md={5}>
                            <FormGroup>
                                ...
                                <Input type="text" id="NR_ENDERECO" name="NR_ENDERECO" value={NR_ENDERECO} onChange={(e) => setNrEndereco(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={5}>
                            <FormGroup>
                                <Label for="DS_ENDERECO">Complemento:</Label>
                                <Input type="text" id="DS_ENDERECO" name="DS_ENDERECO" value={DS_ENDERECO} onChange={(e) => setDsEndereco(e.target.value)}/>
                            </FormGroup>
                        </Col>
                        <Col md={3}>
                            <FormGroup>
                    ...
                    <Row form>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="text" id="CLASSIF_FUNC" name="CLASSIF_FUNC" value={CLASSIF_FUNC} onChange={(e) => setClassifFunc(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label for="PROVA">Prova:</Label>
                                <Input type="text" id="PROVA" name="PROVA" value={PROVA} onChange={(e) => setProva(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    <h2>Uniformes</h2>  
                    <Row form>
                        <Col md={3}>
                            <FormGroup>
                                ...
                                <Input type="text" id="TAMANHO_CAMISA" name="TAMANHO_CAMISA" value={TAMANHO_CAMISA} onChange={(e) => setTamanhoCamisa(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={3}>
                            <FormGroup>
                                <Label for="TAMANHO_AGASALHO">Tamanho do Agasalho:</Label>
                                <Input type="text" id="TAMANHO_AGASALHO" name="TAMANHO_AGASALHO" value={TAMANHO_AGASALHO} onChange={(e) => setTamanhoAgasalho(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={3}>
                            <FormGroup>
                                <Label for="TAMANHO_BERM_CAL">Tamanho da Bermuda/Calça:</Label>
                                <Input type="text" id="TAMANHO_BERM_CAL" name="TAMANHO_BERM_CAL" value={TAMANHO_BERM_CAL} onChange={(e) => setTamanhoBermCal(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={3}>
                            <FormGroup>
                                <Label for="NR_CALCADO">Número do Calçado:</Label>
                                <Input type="number" id="NR_CALCADO" name="NR_CALCADO" value={NR_CALCADO} onChange={(e) => setNrCalcado(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
                    ...
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="file" id="FOTO_ATLETA" name="FOTO_ATLETA" value={FOTO_ATLETA} onChange={(e) => setFotoAtleta(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label className="UploadIMG" for="FOTO_RG">Clique aqui para anexar RG DO(A) ATLETA</Label>
                                <Input type="file" id="FOTO_RG" name="FOTO_RG" value={FOTO_RG} onChange={(e) => setFotoRg(e.target.value)} />
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label className="UploadIMG" for="FOTO_RG_RESPONS">Clique aqui para anexar RG DO(A) RESPONSÁVEL</Label>
                                <Input type="file" id="FOTO_RG_RESPONS" name="FOTO_RG_RESPONS" value={FOTO_RG_RESPONS} onChange={(e) => setFotoRgRespons(e.target.value)} />
                            </FormGroup>
                        </Col>
                    </Row>
